...
\newtcolorbox{defbox}[1]{%
	...
	% --- Change here: fontupper set to black ---
...
\definecolor{myfooterblue}{RGB}{1, 11, 61}

\newtcolorbox{footerblock}[1]{%
	enhanced,
	% Remove shifting: use width of paper and grow to left to ignore margins
	width=\paperwidth,
	grow to left by=\sepwidth, % Adjusts for the default Beamer left margin
	sharp corners,
	boxrule=0pt,
	...
	colupper=white,
	fonttitle=\bfseries\large,
	% Ensure no extra spacing around the box
	boxsep=5mm,
	left=10mm,
	right=10mm
}