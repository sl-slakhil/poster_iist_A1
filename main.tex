...
\begin{frame}[t]
	...
	\begin{columns}[t]
		...
		\begin{column}{\colwidth}
				...
				\begin{figure}
					...
					\vspace{-0.4 cm}
					\caption{Normalized displacement, rotations, bending moment and shear force of cantilever nano-beam}
					\label{fig:my_label}
				\end{figure}
			\end{defbox}
				\begin{defbox}{Numerical Results}{}
	...
	\begin{figure}
		...
		\vspace{-0.4 cm}
		\caption{Normalized displacement, rotations, bending moment and shear force of simply supported nano-beam beam}
		\label{figssb}
	\end{figure}
\end{defbox}
		...
		\end{defbox}
					...
					\begin{footnotesize}
						...
						\bibitem{pinnola2022finite}
						F.~P. Pinnola, M.~S. Vaccaro, R.~Barretta, and F.~M. de Sciarra.
						\newblock Finite element method for stress-driven nonlocal beams.
						\newblock \textit{Engineering Analysis with Boundary Elements}, 134:22--34, 2022.
