...
\begin{frame}[t]
	...
	\begin{columns}[t]
		...
		\begin{column}{\colwidth}
				...
				\begin{figure}
					\centering
					\includegraphics[width = 0.79\textwidth]{pictures/cantileverBeam}
					\vspace{-0.4 cm}
	...
	\begin{figure}
		\centering
		\includegraphics[width = 0.8\textwidth]{pictures/ssb_combined}
		\vspace{-0.4 cm}
...
\end{defbox}
		\begin{defbox}{Scope}
			\begin{figure}
				...
				\caption{A mems resonator \copyright Bhaskaran et al., \copyright scitime, a mems device by \copyright sensing-machines.}
			\end{figure}
		\end{defbox}	
			
		\begin{defbox}{Conclusion}{}
		The development of the SD-EFGM provides an efficient numerical scheme for the static analysis of nonlocal Bernoulli-Euler beams. The method successfully captures critical bending quantities such as displacement, slopes, bending moments, and shear forces. It proves to be a well-posed alternative to strain-driven models, effectively eliminating previous modeling paradoxes while maintaining numerical accuracy through proper selection of the support domain and nodal density. 
		\end{defbox}
		\end{column}		
		\separatorcolumn
	\end{columns}
